...
with DAG(
    dag_id = 'lab1_train_predict_data_pipeline',
    start_date = datetime(2025,10,1),
    catchup=False,
    tags=['ETL'],
    schedule = '50 2 * * *'
) as dag:
    train_input_table = f"raw.lab1_stock_daily"
    train_view = f"analytics.lab1_train_data_view"
    forecast_table = f"analytics.lab1_forecast_data"
    forecast_function_name = f"analytics.predict_stock_price"
    final_table = f"analytics.lab1_market_data"
